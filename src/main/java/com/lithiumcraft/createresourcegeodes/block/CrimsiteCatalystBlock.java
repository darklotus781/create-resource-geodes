...
public class CrimsiteCatalystBlock extends Block {
    ...
    public CrimsiteCatalystBlock(Properties pProperties) {
        ...
        LOGGER.info("Generator: " + String.valueOf(generatorBlock.toString()));
    }
    ...
    public InteractionResult use(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
        ...
        if (!level.isClientSide() && held.getItem() == REDSTONE.asItem()) {
    ...
    private static void generateBlockPlacements(Level level, BlockPos pos, int RADIUS, int CHANCE) {

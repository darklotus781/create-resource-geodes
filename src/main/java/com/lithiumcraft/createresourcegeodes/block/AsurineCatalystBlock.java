...
public class AsurineCatalystBlock extends CatalystBlock {

    public static Block generatorBlock;

    public static final Random RAND = new Random();

    public AsurineCatalystBlock(Properties pProperties) {
        super(pProperties);

        generatorBlock = RegistryObject.create(new ResourceLocation("create:asurine"), ForgeRegistries.BLOCKS).get();
    }
